...
RUN_A = [
    ...
    "HHKBEEEBBBNNBBBEEEBKHH..",
    "..KBBBBBBBMMBBBBBBBK....",
    "..KBBBBBBBBBBBBBBBBKKKK.",
    "...KBBBBBBBBBBBBBBKKBBBK",
    "..KBBBBBBBBBBBBBBBKKKBBK",
    "..KBBBBBBBBBBBBBBBBK.KK.",
    "..KBBBBBBBBBBBBBBBBK....",
    "...KBBKKBBK..KBBKKBBK...",
    "...KBBKKWWK..KWWKKBBK...",
    "...KWWKKWWK..KWWKKWWK...",
...
SIT_C = [
    ...
    ".KBBBBKBBBBBBBBKBBBBK...",
    ".KBBBBKBBBBBBBBKBBBBK...",
    ".KBBBBKBBBBBBBBKBBBBKKK.",
    ".KBBBBKBBBBBBBBKBBKKKBBK",
    ".KBBBBKBBBKKBBBKBKBKKKK.",
    ".KBBBBKWWBKKBWWKBKBK....",
    ".KBBBBKWWBKKBWWKBKK.....",
    "..KKKKKKKKKKKKKKKKKKKK..",
    "........................",
...
FRAMES = {
    ...
    "sit_c": SIT_C, "sleep_b": SLEEP_B, "yawn": YAWN,
    "groom_a": GROOM_A, "groom_b": GROOM_B, "blink_half": BLINK_HALF,
    "run_c": RUN_C, "run_d": RUN_D, "knead_c": KNEAD_C,
}

EYE_CELLS = {
    "sit_a": [(4, 7), (15, 7)], "sit_b": [(4, 7), (15, 7)],
    "sit_c": [(4, 7), (15, 7)],
    "type_a": [(3, 6), (14, 6)], "type_b": [(3, 6), (14, 6)],
    "knead_a": [(4, 7), (15, 7)], "knead_b": [(4, 7), (15, 7)],
    "run_a": [(4, 7), (15, 7)], "run_b": [(4, 7), (15, 7)],
    "run_c": [(4, 6), (15, 6)], "run_d": [(4, 7), (15, 7)],
    "knead_c": [(4, 7), (15, 7)],
    "dangle": [(4, 9), (15, 9)], "peek": [(4, 19), (15, 19)],
}

HEAD_RECT = (2, 1, 21, 12)
SCROLL_ROLL = (1, 17)           # roll sits under the reaching paw
SIT_A_REF = SIT_A
